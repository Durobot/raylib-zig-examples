...
1. Install Zig. Version **0.11** (or 0.12 development build, see below) is required. Download zig 0.11 for Linux from https://ziglang.org/download/. The file is named **zig-linux-x86_64-0.11.0.tar.xz**.
   ...
   Latest version of Zig **0.12** I have tested the project with was **0.12.0-dev.3052+4e2570baa**. Later versions may or may not work, you're welcome to try them and raise an issue on github if they don't.
